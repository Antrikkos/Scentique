...
export default function AdminPage() {
  ...
  return (
    <div className="bg-white mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-3">
      ...
      <div className="text-left">
        <div className="border-b">
          <div className='flex flex-row px-2 font-semibold text-sm'>
            ...
            <div className="basis-1/12">Total</div>
            <div className="basis-1/12">Paid</div>
            <div className="basis-1/12">Delivered</div>
            <div className="basis-1/12">View Order</div>
          </div>
        </div>
        <div className="">
                ...
                {({ open }) => (
                  <div className='flex flex-col'>
                    <Disclosure.Button className="flex flex-row px-2 rounded-md py-2 text-left text-sm bg-gray-100 hover:bg-gray-200">
                      ...
                      <div className="basis-1/12">{order.createdAt.substring(0, 10)}</div>
                      ...
                      <div className="basis-1/12">€{order.totalPrice}</div>
